...
public class Main {
	...
	private static TotalRevenueView revenueView;
	...
	public static void main(String[] args) {
		...
		revenueView = new TotalRevenueView(register.getMoney());
		
		register.attachRevenueObserver(revenueView);
		
		// Run sample execution that simulates a real PoS situation
		while(true) {
			System.out.println("---------------- New Sample Execution ----------------");
